...
if Date_to_numbers(Month ,Day, Year)== range(357,366) or range(1,19):
    zodiac = "a Capricorn"
elif Date_to_numbers(Month ,Day, Year)in range(20,50):
    zodiac = "an Aquarius"
elif Date_to_numbers(Month ,Day, Year)in range(51,82):
    zodiac = "a Pisces"
elif Date_to_numbers(Month ,Day, Year)in range(83,113):
    zodiac = "an Aries"
elif Date_to_numbers(Month ,Day, Year)in range(114,145):
    zodiac = "a Taurus"
elif Date_to_numbers(Month ,Day, Year)in range(146,177):
    zodiac = "a Gemini"
elif Date_to_numbers(Month ,Day, Year)in range(178,210):
    zodiac = "a Cancer"
elif Date_to_numbers(Month ,Day, Year)in range(211,241):
    zodiac = "a Leo"
elif Date_to_numbers(Month ,Day, Year)in range(242,273):
    zodiac = "a Virgo"
elif Date_to_numbers(Month ,Day, Year)in range(274,304):
    zodiac = "a Libra"
elif Date_to_numbers(Month ,Day, Year)in range(305,335):
    zodiac = "a Scorpio"
elif Date_to_numbers(Month ,Day, Year)in range(336,356):
